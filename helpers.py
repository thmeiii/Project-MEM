def validUserPass(accountType, username, password):
    #loop through each line of the users text file checking if there is a line where the account type, username, and password all match.
    #return true if you find one, otherwise false.
    return True
